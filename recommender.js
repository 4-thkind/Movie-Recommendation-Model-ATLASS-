...
import { TMDB_API_KEY, DEFAULT_RECS } from './config.js?v=12';
import { buildCard, updateDatabaseStatus, renderRows, buildTrending, buildPlatforms, initHero, makeRowInfinite } from './ui.js?v=12';
